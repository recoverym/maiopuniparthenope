...
5) Go to the synchronization setting page on 'admin/config/ls_sync' 
...
******************************************************************** 
I LIKE YOUR WORK, WHERE CAN I DONATE ?

Go to : 
https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3FE 
LZFULJ97TA 
